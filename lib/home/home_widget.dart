...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: GetAccountBookCall.call(
        email: currentUserEmail,
      ...
      builder: (context, snapshot) {
        ...
        final homeGetAccountBookResponse = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
          appBar: AppBar(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            dateTimeFormat('y.M.d(E)', getCurrentTimestamp),
                  ...
                  Align(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (FFAppState().WriteAccountBook == true)
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 10.0),
                            child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              _model.writeAccountBook =
                                                  await WriteAccountBookCall
                                                      .call(
                                                email: currentUserEmail,
                                                property:
                                                    _model.textController1.text,
                                                costs: int.tryParse(_model
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              setState(() {
                                FFAppState().WriteAccountBook = true;
                              });
                            },
                            text: '+',
                            options: FFButtonOptions(
