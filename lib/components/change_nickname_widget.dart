...
import 'change_nickname_model.dart';
export 'change_nickname_model.dart';

class ChangeNicknameWidget extends StatefulWidget {
  const ChangeNicknameWidget({Key? key}) : super(key: key);
...
class _ChangeNicknameWidgetState extends State<ChangeNicknameWidget>
  ...
  late ChangeNicknameModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChangeNicknameModel());
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              _model.changeProfileName =
                                  await ChangeNicknameCall.call(
                                profileName: _model.nicknameController.text,
                                email: currentUserEmail,
                              );
                              if ((_model.changeProfileName?.succeeded ??
                                  true)) {
