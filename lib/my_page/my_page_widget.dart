  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.getNickname?.succeeded ?? true)) {
        _model.getProfileImage = await GetProfileImageCall.call(
          email: currentUserEmail,
        );
        if ((_model.getProfileImage?.succeeded ?? true)) {
          setState(() {
            _model.mypagereload = false;
          });
        }
      }
    });
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.network(
                        getJsonField(
                          (_model.getProfileImage?.jsonBody ?? ''),
                          r'''$.data.profileImg''',
                        ),
                        width: 200.0,
                        height: 200.0,
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            _model.uploadProfileImage =
                                await ChangeProfileImageCall.call(
                              profileImage: _model.uploadedLocalFile,
                              email: currentUserEmail,
                            );
                            if ((_model.uploadProfileImage?.succeeded ??
                                true)) {
